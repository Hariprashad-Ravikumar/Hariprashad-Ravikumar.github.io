export default function TerminalStatusLine({ text }: { text: string }) {
  return (
    <span className="inline-flex items-center gap-2 rounded-[var(--r-sm)] border border-[var(--glass-border)] bg-[var(--ink-900)] px-3 py-1.5 font-mono text-xs text-[var(--accent-400)]">
