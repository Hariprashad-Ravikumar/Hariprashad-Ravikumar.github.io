...
export const INDUSTRY_EXPERIENCE = [
  {
    ...
    bullets: [
      ...
      "Built and deployed a full-stack enterprise Dash/Plotly simulation platform packaged as a modular Python library, adopted by senior R&D engineers and subject-matter experts in WD's sputtering and media engineering teams across the US and Japan (40+ users).",
