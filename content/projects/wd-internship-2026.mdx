...
<div className="float-none sm:float-right ml-6 mb-4 mt-2 sm:max-w-[200px]">
  <Picture
    src="/images/wd/WD-IDCard"
    alt="Western Digital ID Card"
    width={1920}
    height={1440}
    className="rounded-xl shadow-sm border border-[var(--line)]"
  />
</div>
...
<div className="float-none sm:float-right ml-6 mb-4 mt-2 sm:max-w-[220px]">
  <Picture
...
<div className="rounded-xl border border-[var(--line)] bg-[var(--surface-0)] p-4 shadow-sm my-6 w-full">
  <Mermaid>
  {`graph TD
      %% Styling
