...
<div className="float-none sm:float-right ml-6 mb-4 sm:-mt-[174px] sm:max-w-[330px] flex flex-col gap-2">
...
<div className="float-none sm:float-right ml-6 mb-4 sm:max-w-sm flex flex-col gap-4">
  <Picture
...
<div className="float-none sm:float-right ml-6 mb-4 mt-2 sm:max-w-[256px]">
  <Picture
